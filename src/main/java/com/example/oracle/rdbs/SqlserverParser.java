...
public class SqlserverParser {
     ...
     * @return
     */
    public String convertToPageSql(String sql) throws Exception {
     ...
     * @return
     */
    public String convertToPageSql(String sql, Integer offset, Integer limit) throws Exception {
        //解析SQL
        Statement stmt;
        try {
     ...
     * @return
     */
    protected Select getPageSelect(Select select) throws Exception {
        ...
        if (((PlainSelect) selectBody).getTop() != null) {
            throw new Exception("被分页的语句已经包含了Top，不能再通过分页插件进行分页查询!");
        }
        //获取查询列
     ...
     * @return
     */
    protected SelectBody wrapSetOperationList(SetOperationList setOperationList) throws Exception{
        //获取最后一个plainSelect
        ...
        if (!(setSelectBody instanceof PlainSelect)) {
            throw new Exception("目前无法处理该SQL，您可以将该SQL发送给abel533@gmail.com协助作者解决!");
        }
     ...
     * @return ROW_NUMBER() 列
     */
    protected SelectItem addRowNumber(PlainSelect plainSelect, List<SelectItem> autoItems) throws Exception {
        //增加ROW_NUMBER()
    ...
    protected List<OrderByElement> getOrderByElements(PlainSelect plainSelect,
                                                      List<SelectItem> autoItems) throws Exception {
            ...
            if (selectExpressionItem != null) { // OrderByElement 在查询列表中
                ...
                if (alias != null) { // 查询列含有别名时用查询列别名
                    ...
                    if (expression instanceof Column) {
                        ...
                        throw new Exception("列 \"" + expression + "\" 需要定义别名");
                    }
                }
    ...
    public static void main(String[] args) throws Exception{
        ...
        String originalSql = "select name, sum(age) age from liliangbin group by name";
        System.out.println(parser.convertToPageSql(originalSql, 0, 13));
    }
}